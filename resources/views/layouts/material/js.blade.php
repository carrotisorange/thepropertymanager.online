...
<script src="{{ asset('/material/assets/js/core/popper.min.j') }}s"></script>
...
<script src="{{ asset('materia/assets/js/plugins/bootstrap-tagsinput.j') }}"></script>
...
<!--  Google Maps Plugin    -->
<script src="{{ asset('/material/https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE') }}"></script>
<!-- Chartist JS -->
