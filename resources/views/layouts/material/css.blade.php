<meta charset="utf-8" />
<link rel="apple-touch-icon" sizes="76x76" href="{{ asset('/arsha/assets/img/favicon.ico') }}">
<link rel="icon" type="image/png" href="{{ asset('/arsha/assets/img/apple-touch-icon.png') }}">
