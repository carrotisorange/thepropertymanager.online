...
{{--                     
                  ...
                  <br> --}}
                    ...
                    <div class="form-group">
                     <div class="row">
                      <div class="col">
                        <select name="country" id="country" class="form-control form-control-user @error('country') is-invalid @enderror" name="country"  required autocomplete="country" autofocus>
