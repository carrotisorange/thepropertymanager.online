  ...
  @csrf
      ...
      <div class="form-group">
        <label for="">Property type</label>
            ...
            <div class="form-check">
              <input class="form-check-input form-control-user @error('property_type_id') is-invalid @enderror" type="radio" name="property_type_id_foreign" id="exampleRadios1" value="{{ $item->property_type_id }}" required>
     ...
     <div class="row">
      {{-- <div class="col">
       ...
       <div class="col-md-12">
        <p class="text-right">
          <button type="submit" class="btn btn-block btn-primary" onclick="this.form.submit(); this.disabled = true;"><i class="fas fa-arrow-right"></i> Continue</button>
        </p>
       </div>
     </div>
    </form>  
