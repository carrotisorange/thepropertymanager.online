  ...
  <div class="col">
    <ol>
      ...
      <p class="text-justify">
        ...
        Firstly, you need to add the property itself. It is being done after the registration. The other one is to add
        your co-users, which will be explained below.
        ...
        which is automatically selected when you click the <button class="btn btn-sm btn-primary">Manage</button>on the
        My Properties page.
        If you are on Advance or Enterprise plan, you can add more properties by clicking the <button
          class="btn btn-sm btn-primary"> Property </button>.
      </p>
      <li id="addingusers">Adding users.</li>
      <br>
      <p class="text-justify">
        These other users are the equivalent of employees in a real property management office.
        The <button class="btn btn-sm btn-primary">Users (1/2)</button> allows you to add additional users such as the
        admin, billing, treasury, and the account payables (ap).
        ...
        In comparison, the Advance plan gives you 3 with the addition of billing, and the Enterprise plan unlocks the
        feature to create all five types of users, including the
      ...
      <br>
      <p class="text-justify">
        After you have added your first property and other users, press the <button
          class="btn btn-sm btn-primary">Manage</button>to start adding rooms. You will be redirected to the
        Dashboard <a><i class="fas fa-tachometer-alt text-orange"></i></a>
        and you will see the overview of all the metrics and charts that your property will need to fill as you add
        rooms, tenants, contracts, and etc.
        Go to the Home <a><i class="fas fa-home text-indigo"></i></a>
        and at the right side click the <button class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add</button>,
        and fill-up the information, and hit the submit button.
        The Add button allows you to add as many rooms as you want in a single click (consider upgrading your plan if
        ...
        will start with the floor number you have selected, and which you have the option to change later by clicking
        the <button class="btn btn-sm btn-primary"><i class="fas fa-edit"></i> Edit</button>.
        <br><br>
        Furthermore, the status of the newly created rooms will be vacant. The rooms can be viewed as a whole, sorted
        based on the floor no, and categorically per building, which allows you to navigate easily
        to all the rooms.
      </p>
      <li id="deletingrooms">Archiving/Deleting rooms.</li>
      <br>
      <p class="text-justify">
        If you accidentally added incorrect number of rooms or just want to delete a room, you can do so by clicking the
        <button class="btn btn-sm btn-primary"><i class="fas fa-edit"></i> Edit</button> located beside
        the <button class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add</button> in the Home <a><i
            class="fas fa-home text-indigo"></i></a>. But remember rooms are not totally deleted
        ,rather rooms are just put on deleted status, and which can be restored anytime. Rooms with deleted status will
        no longer appear anywhere in the property, but in the <button class="btn btn-sm btn-primary"><i
            class="fas fa-edit"></i> Edit</button>.
      </p>
      <li id="addingtenants">Adding tenants.</li>
      <br>
      <p class="text-justify">
        To add a tenant to your property, select a particular room from the Home <a><i
            class="fas fa-home text-indigo"></i></a>.
        Inside the room navigate to the <a href="#/" role="tab" aria-controls="nav-tenants" aria-selected="false"><i
            class="fas fa-users fa-sm text-primary-50"></i> Tenants</a> tab,
        and click the <button class="btn btn-sm btn-primary"><i class="fas fa-user-plus"></i> Add</button>. Once
        clicked, you will be redirected to a page to add the tenant information,
        contract details, and bill information. If you wish to go back to the room, you can click the <button
          class="btn btn-sm btn-primary"><i class="fas fa-home"></i> Home</button> at the top-left of the page.
        <br><br>
        There will be three input fields on the topmost part of the page: Room, Referrer, and Point of contact. Fields
        with a red asterisk indicate that it is required.
        For instance, the Referrer <b class="text-danger">(*)</b> needs to be selected in order to submit the form.
        Firstly, the room's field is automatically filled up as you selected the room.
        The Referrer's field will let you select the person who referred the tenant to stay in the property. The list of
        user all users will show in this field,
        including the manager. If no one referred the tenant, select the None option. Lastly, the point of contact will
        allow you to choose the point
