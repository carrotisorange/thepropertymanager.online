      ...
      <br>
        <p class="text-justify">
          ...
          treasury and the ap to execute your property management processes seamlessly.
              ...
              <p class="font-italic">Users and their privileges</p>
              <ol>
          ...
          <br>
            <p class="text-justify">
              ...
              The add button allows you to add as many rooms as you want in a single click (consider ugrading your plan if you want to add more.).
              ...
              <br><br>
              Furthermore, the status of the newly created rooms will be vacant. The rooms can be viewed as a whole, sorted based on the floor no, and categorically per building, which allows you to easily navigate
              to all the rooms.
              </p>
              <li>Archiving/Deleting rooms.</li>
              <br>
              <p class="text-justify">
