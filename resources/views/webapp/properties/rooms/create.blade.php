...
<div class="card-body px-lg-5 py-lg-5">
  <form id="addPayableEntryForm" method="POST" action="/property/{{ Session::get('property_id') }}/rooms/store">
    ...
    <div class="row">
      <div class="col">
        <p class="text-right">
          ...
          <a href="#/" id='delete_entry' class="btn btn-danger"><i class="fas fa-minus"></i> Remove current building
          </a>
        </p>
    ...
    <div class="row">
      <div class="col">
        <button type="submit" form="addPayableEntryForm" class="btn btn-primary btn-block"><i
