...
<form id="createContractForm"
  action="/property/{{ Session::get('property_id') }}/room/{{ $room->unit_id }}/tenant/{{ $tenant->tenant_id }}/store/contract"
  method="POST">
  @csrf
</form>
      ...
      <div class="card-body">
        <div class="form-row">
          <div class="form-group col-md-4">
            ...
            <input form="createContractForm" value="{{ $room->building.' '.$room->unit_no }}" class="form-control"
              type="text" required readonly>

          </div>
          <div class="form-group col-md-4">
            <label for="">Beds:</label>
            <input form="createContractForm" value="{{ $room->occupancy }} pax" class="form-control" type="text"
              required readonly>
          </div>
          <div class="form-group col-md-4">
        ...
        <div class="form-row">
          <div class="form-group col-md-3">
            ...
            <input name="movein_at" id="movein_at" form="createContractForm" value="{{ old('movein_at') }}"
              onchange='autoFill()' class="form-control" type="date" required>
            @error('movein_at')
            <small class="text-danger">
              {{ $message }}
            </small>
          ...
          <div class="form-group col-md-3">
            ...
            <input name="moveout_at" id="moveout_at" form="createContractForm" value="{{ old("moveout_at") }}"
              onchange='autoFill()' class="form-control" type="date" required>
            @error('moveout_at')
            <small class="text-danger">
              {{ $message }}
          ...
          <div class="form-group col-md-3">
            ...
            <input name="number_of_months" id="number_of_months" form="createContractForm"
              value="{{ old('number_of_months') }}" class="form-control" type="text" required readonly>
          ...
          <div class="form-group col-md-3">
            ...
            <input name="term" id="term" form="createContractForm" value="{{ old('term') }}" class="form-control"
              type="text" required readonly>
            @error('term')
            <small class="text-danger">
              {{ $message }}
        ...
        <div class="form-row">
          <div class="form-group col-md-3">
            <label for="">Rent/mo:</label>
            <input name="rent" id="rent" form="createContractForm" value="{{ $room->rent - old('discount') }}"
              class="form-control" type="number" required>
            <input form="createContractForm" type="hidden" class="" name="original" min="1" id="original"
          ...
          <div class="form-group col-md-3">
            ...
            <input name="discount" id="discount" form="createContractForm" value="{{ old('discount') }}"
              class="form-control" type="number" required>
            @error('discount')
            <small class="text-danger">
              {{ $message }}
