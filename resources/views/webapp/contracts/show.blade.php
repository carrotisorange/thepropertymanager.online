...
<div class="row">
  ...
  <div class="col-md-10 mx-auto">
    <div class="form-group row">
      ...
      <div class="col">
        <a target="_blank" href="/property/{{Session::get('property_id')}}/room/{{ $contract->unit_id_foreign }}">View</a>
      </div>
    ...
    <div class="form-group row">
      ...
      <div class="col">
        ...
        <i class="fas fa-clock text-warning"></i> {{ $contract->status }} ({{ $contract->moveout_reason? $contract->moveout_reason: 'NOT AVAILABLE' }})
        @else
    ...
    <div class="form-group row">
      ...
      <div class="col">
        {{ Carbon\Carbon::parse($contract->movein_at)->format('M d, Y') }} - {{ Carbon\Carbon::parse($contract->moveout_at)->format('M d, Y') }} ({{ $contract->number_of_months }}) ({{ $contract->term }})
      </div>
