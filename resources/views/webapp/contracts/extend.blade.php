  ...
  <div class="col-auto text-right">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class=" breadcrumb-item"><a
              href="/property/{{ Session::get('property_id') }}/tenant/{{ $contract->tenant_id_foreign }}/contract/{{ $contract->contract_id }}/">Contract
              ID: {{ $contract->contract_id }}</a></li>
...
<div class="row">
  <form id="extendContractForm"
    action="/property/{{Session::get('property_id')}}/tenant/{{ $contract->tenant_id_foreign}}/contract/{{$contract->contract_id}}/extend"
    method="POST">
    @csrf
  </form>
</div>
<div class="row">
  <div class="col-md-12">
    ...
    <input class="form-control" type="date" form="extendContractForm" name="movein_at"
      value="{{ Carbon\Carbon::parse($contract->moveout_at)->format('Y-m-d') }}" required>
  </div>
</div>
<br>
...
<div class="row">
  <div class="col-md-12">
    <p class="text-right">
      ...
      <button type="submit" form="extendContractForm" class="btn btn-success btn-user btn-block btn-sm"
