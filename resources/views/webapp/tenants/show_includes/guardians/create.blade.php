<div class="modal fade" id="addGuardian" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="guardianForm"
                    action="/property/{{Session::get('property_id')}}/tenant/{{ $tenant->tenant_id }}/guardian"
                    method="POST">
                    @csrf
                </form>
            ...
            <div class="modal-footer">
                <button type="submit" form="guardianForm" class="btn btn-primary btn-sm"
