    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-3">
            Date
            {{-- <input type="date" class='form-control' form="addBillForm" class="" name="date_posted" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}"
            required > --}}
            <input class='form-control' type="date" form="addBillForm"
              value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" name="date_posted" required>
