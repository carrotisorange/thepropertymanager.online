...
<div class="modal fade" id="addViolation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="violationForm"
                    action="/property/{{Session::get('property_id')}}/tenant/{{ $tenant->tenant_id }}/violation"
                    method="POST">
                    @csrf
                </form>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="date" form="violationForm" class="form-control" name="created_at"
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <select class="form-control" form="violationForm" name="category" id="" required>
                            ...
                            <option value="{{ $item->violation_type_id }}">{{ $item->title }} - {{ $item->description }}
                            </option>
                            @endforeach
                        </select>
                    </div>
            ...
            <div class="modal-footer">
                <button form="violationForm" type="submit" class="btn btn-sm btn-primary"
