<div class="modal fade" id="addInvestor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="addInvestorForm"
                action="/property/{{Session::get('property_id')}}/room/{{ $home->unit_id }}/owner" method="POST">
                @csrf
            </form>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input form="addInvestorForm" type="email" class="form-control" name="owner_email" id="owner_email"
                        required>
                </div>
                <div class="form-group">
                    <label>Mobile</label>
            ...
            <div class="modal-footer">
                <button type="submit" form="addInvestorForm" class="btn btn-primary btn-sm"
