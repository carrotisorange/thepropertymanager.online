...
@endif --}}
 ...
 <span class=""> <small> Showing <b>{{ $tenants->count() }} </b> of {{ $count_tenants }} {{ Str::plural('tenant', $count_tenants) }} </span></small>
    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
            ...
            <th><a href="/property/{{Session::get('property_id')}}/tenant/{{ $item->tenant_id }}/#bills">{{ $item->first_name.' '.$item->last_name }}</a></th>
            <th><a href={{ route('show-tenant', ['property_id' => Session::get('property_id'),'tenant_id' => $item->tenant_id]) }}">{{ $item->building.' '.$item->unit_no }}</a></th>
