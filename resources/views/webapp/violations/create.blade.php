  ...
  <div class="container">
    ...
    <div class="row ">
      ...
      <div class="col-md-12 py-3 border">
        <form id="violationTenantForm"
          action="/property/{{Session::get('property_id')}}/tenant/{{ $tenant->tenant_id }}/violation/store"
          method="POST">
          @csrf
        </form>
        ...
        <div class="form-row">
          <div class="form-group col-md-4">
            <input form="violationTenantForm" name="created_at" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}"
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            <textarea form="violationTenantForm" name="summary" placeholder="Details of the violation" cols="40"
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            <textarea form="violationTenantForm" name="sanction" placeholder="Sanction..." cols="40" rows="5"
        ...
        <div class="form-row">
          <a href="/property/{{ Session::get('property_id') }}/tenant/{{ $tenant->tenant_id }}#violations"
            class="btn btn-secondary btn-sm"><i class="fas fa-times"></i> Cancel</a>
          <button form="violationTenantForm" type="submit" class="btn btn-primary btn-sm"><i class="fas fa-check"></i>
            Submit</button>
        </div>
