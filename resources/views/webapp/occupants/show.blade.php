    ...
    <nav>
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        @if($access->count() <=0 ) <a class="nav-item nav-link" id="nav-user-tab" data-toggle="tab" href="#user"
          role="tab" aria-controls="nav-user" aria-selected="false"><i class="fas fa-user-circle text-dan"></i> Access
          ...
          <a class="nav-item nav-link" id="nav-user-tab" data-toggle="tab" href="#user" role="tab"
            aria-controls="nav-user" aria-selected="false"><i class="fas fa-user-circle text-dark"></i> Access </a>
          @endif

          <a class="nav-item nav-link" id="nav-contracts-tab" data-toggle="tab" href="#contracts" role="tab"
            aria-controls="nav-contracts" aria-selected="false"><i class="fas fa-home text-indigo"></i>
...
<div class="row">
  <div class="col-md-12">
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="nav-profile-tab">
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <a href="/property/{{Session::get('property_id')}}/occupant/{{ $tenant->tenant_id }}/edit"
              class="btn btn-primary btn-sm"><i class="fas fa-user-edit"></i> Edit</a>
            @endif
          ...
          <div class="col-md-4">
            ...
            <form id="uploadImageForm"
              action="/property/{{ $property->property_id}}/tenant/{{ $tenant->tenant_id }}/upload/img" method="POST"
      ...
      <div class="tab-pane fade" id="contracts" role="tabpanel" aria-labelledby="nav-contracts-tab">
        ...
        <div class="row">
                ...
                <tr>
                  {{-- <th>
                    <div class="form-check form-check-inline">
                     <input class="form-check-input" type="checkbox" onclick="selectOne()" id="checkbox{{$item->contract_id}}"
          ...
          <td>{{ $item->building }}</td>
          <td><a
              href="/property/{{Session::get('property_id')}}/unit/{{ $item->unit_id_foreign }}">{{ $item->unit_no }}</a>
          </td>
    ...
    <div class="tab-pane fade" id="user" role="tabpanel" aria-labelledby="nav-user-tab">
      @if($access->count() <=0 ) <button href="#" class="btn btn-primary btn-sm" data-toggle="modal"
        data-target="#userAccess" data-whatever="@mdo"><i class="fas fa-plus"></i> Create access to the system</button>
        <br><br>
        @endif
        ...
        <div class="col-md-12 mx-auto">
          ...
          <div class="table-responsive text-nowrap" style="overflow-y:scroll;overflow-x:scroll;height:450px;">
            @if($access->count() <= 0) <p class="text-center text-danger">No credentials found!</p>
...
<div class="modal fade" id="userAccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-primary" id="exampleModalLabel"><i class="fas fa-user-lock"></i> Add Credentials
        </h5>
      ...
      <div class="modal-body">
        ...
        <form id="userForm" action="/property/{{$property->property_id}}/tenant/{{ $tenant->tenant_id }}/user/create"
          method="POST">
          @csrf
        </form>
        <table class="table table-borderless">
          <tr>
            ...
            <td><input type="text" name="name" form="userForm"
                ...
                value="{{ $tenant->first_name.' '.$tenant->last_name }}" required>
              <br>
              @error('name')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
          ...
          <tr>
            ...
            <td><input type="email" name="email" form="userForm"
                ...
                value="{{ $tenant->tenant_unique_id.'@thepropertymanager.online' }}" required>
              <br>
              @error('email')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
          ...
          <tr>
            ...
            <td><input type="text" name="password" form="userForm"
                ...
                value="{{ $tenant->password }}" required>
              <br>
              @error('password')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
...
<div class="modal fade" id="addBill" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
  ...
  <div class="modal-dialog modal-xl" role="modal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addBillForm"
          action="/property/{{Session::get('property_id')}}/tenant/{{ $tenant->tenant_id }}/bills/create" method="POST">
          @csrf
        </form>
        ...
        <div class="row">
          <div class="col">
            ...
            required > --}}
            <input type="date" class="form-control" form="addBillForm" class="" name="date_posted"
        ...
        <div class="row">
          <div class="col">
            ...
            <p class="text-right">
              <span id='delete_bill' class="btn btn-danger"><i class="fas fa-minus fa-sm text-white-50"></i>
                Remove</span>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i
            class="fas fa-times fa-sm text-dark-50"></i> Cancel </button>
