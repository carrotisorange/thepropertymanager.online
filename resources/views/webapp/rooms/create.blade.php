        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select class="form-control" form="createRoomForm" name="unit_type_id_foreign" id="unit_type_id_foreign" required>
                  ...
                  <div class="form-group residential">
                    ...
                    <input form="createRoomForm" type="number" min="1" value="{{ old('no_of_rooms') }}" class="form-control" name="no_of_rooms" required>
                    @error('no_of_rooms')
                    <small class="text-danger">
                        {{ $message }}
                    </small>
                @enderror
                  ...
                  <div class="form-group residential">
                      ...
                      <input form="createRoomForm" type="text" value="{{ old('building') }}" class="form-control" name="building" placeholder="Building 2">
                      
                  </div>
        
                  <div class="form-group residential">
                    <label >Size <small>(sqm)</small></label>
                    <input form="createRoomForm" type="number" value="{{ old('size') }}" min="0.001" step="0.001" class="form-control" name="size" placeholder="20" required>
                  ...
                  <div class="form-group residential">
                    <?php $numberFormatter = new NumberFormatter('en_US', NumberFormatter::ORDINAL) ?>
                      <label>Floor</label>
                      <select class="form-control" form="createRoomForm" name="unit_floor_id_foreign" id="unit_floor_id_foreign" onchange ="autoFillInitialName()" required>
                ...
                @enderror
                      ...
                      <div class="form-group residential">
                        ...
                        <input form="createRoomForm" type="number" min="1"  value="{{ old('occupancy') }}" class="form-control" name="occupancy">
                        @error('occupancy')
                        <small class="text-danger">
                            {{ $message }}
                        </small>
                    ...
                    <div class="form-group residential">
                        ...
                        <input form="createRoomForm" type="number" value="{{ old('rent') }}" step="0.01" class="form-control" name="rent" id="rent">
                        @error('rent')
                        <small class="text-danger">
                            {{ $message }}
                        </small>
                    ...
                    <div class="form-group">
                        <button type="submit" form="createRoomForm" class="btn btn-primary btn-block" onclick="this.form.submit(); this.disabled = true;"> Save</button>
                        <br>
                        <p class="text-center">
