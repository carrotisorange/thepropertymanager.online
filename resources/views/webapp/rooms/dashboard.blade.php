    ...
    <div class="card shadow">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <ol class="">
            <li>You can now add additional users that have access to your property with specific privileges (manager,
              admin, treasury, billing, and ap). Take note this is only available for manager role. - <span
                class="font-italic">September 01, 2020</span></li>
            <i class="fas fa-question-circle fa-sm text-dark-50"></i> Users Page>Click Add Button> <a href="/users">Try
              it here...</a>
            ...
            <li>You can now send a message for any concern/request regarding the usage of the The Property Manager by
              clicking the messenger logo at the most left-button of your screen. - <span class="font-italic">October
                01, 2020</span></li>
            <li>You can now edit multiple rooms all at the same time. - <span class="font-italic">October 1, 2020</span>
            </li>
            <i class="fas fa-question-circle fa-sm text-dark-50"></i> Home Page>Click the Edit button at the most
            left-top of your screen, <a href="/rooms">Try it here...</a>
            <li>You can now request, approve, decline, release payables to monitor expenses. - <span
                class="font-italic">October 10, 2020</span></li>
            <i class="fas fa-question-circle fa-sm text-dark-50"></i> Payables Page>Click the add button, <a
              href="/payables">Try it here </a>.
            <li>You can now add response to a particular concern. Also, you can now rate an employee based on how the
              concern is resolved (Only available for admin and manager roles). - <span class="font-italic">October 20,
                2020</span></li>
            <i class="fas fa-question-circle fa-sm text-dark-50"></i> Concerns Page>Select a concern
            (Description)>Scroll down <a href="/concerns">Try it here...</a>
            <li>You can rate an employee when a concern is resolved. add additional users that have access to your
              property with specific privileges (manager, admin, treasury, billing, and ap). Take note this is only
              available for manager role. - <span class="font-italic">September 01, 2020</span></li>
            <i class="fas fa-question-circle fa-sm text-dark-50"></i> Users Page>Click Add Button> <a href="/users">Try
              it here...</a>
                ...
                <form action="/units/{{ $item->unit_id }}/tenants/{{ $item->tenant_id }}/alert/contract">
                  ...
                  <button class="btn btn-primary btn btn-primary" type="submit"
                    onclick="this.form.submit(); this.disabled = true;"><i
                      class="fas fa-paper-plane fa-sm text-white-50"></i> Send Notice</button>
                  @else
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  @if(Auth::user()->role_id_foreign === 4 || Auth::user()->role_id_foreign === 1 )
                  <a
                    href="/units/{{ $item->unit_id }}/tenants/{{ $item->tenant_id }}">{{ $item->first_name.' '.$item->last_name }}</a>
                  @else
                  <a
                    href="/units/{{ $item->unit_id }}/tenants/{{ $item->tenant_id }}/billings">{{ $item->first_name.' '.$item->last_name }}</a>
                  @endif
                </td>
                <td>
                  @if(Auth::user()->role_id_foreign === 4 || Auth::user()->role_id_foreign === 1 )
