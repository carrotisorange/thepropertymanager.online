...
<div class="row align-items-center py-4">
  ...
  <div class="col-lg-6 text-right">
    ...
    @else
   <p class="text-right">
           <button type="submit" form="editUnitsForm" class="btn btn-primary"  onclick="return confirm('Are you sure you want perform this action?'); this.disabled = true;"> Save</button>
       </p>
    @endif
  </div>
