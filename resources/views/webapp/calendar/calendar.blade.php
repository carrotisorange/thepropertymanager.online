    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="eventForm" action="/event" method="POST">
          ...
          <input form="eventForm" type="hidden" class="form-control" name="property_id"
            value="{{Session::get('property_id')}}" required>
      ...
      <div class="modal-footer">
        <p class="text-right">
          <button form="eventForm" class="btn btn-primary btn btn-primary" type="submit"
            onclick="this.form.submit(); this.disabled = true;"><i class="fas fa-check fa-sm text-white-50"></i>
            Submit</button>
        </p>
      </div>
