...
<form id="createCertificateForm"
    action="{{ route('store-certificate', ['property_id'=> Session::get('property_id'), 'owner_id' => $owner->owner_id]) }}"
    method="POST">
    @csrf
</form>
        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input form="createCertificateForm" class="form-control" type="date" name="date_purchased"
                        value="{{ old('date_purchased')? old('date_purchased'):Carbon\Carbon::now()->format('Y-m-d') }}"
                        required>
                ...
                <div class="form-group">
                    ...
                    <select form="createCertificateForm" class="form-control" name="unit_id_foreign" id="" required>
                        <option value="{{ old('unit_id_foreign')? old('unit_id_foreign'): "" }}">
                            {{ old('unit_id_foreign')? old('unit_id_foreign'): "Please select one" }}</option>
                ...
                <div class="form-group">
                    ...
                    <input form="createCertificateForm" class="form-control" type="number" min="0" step="0.001"
