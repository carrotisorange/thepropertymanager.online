...
<div class="row align-items-center py-4">
  <div class="col-lg-12">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/property/{{ Session::get('property_id') }}/remittances/">Remittances #
            {{ $remittance->remittance_id }}</a></li>
...
@if($expenses->count() <=0 ) <p class="text-danger text-center">No expenses found!</p>
