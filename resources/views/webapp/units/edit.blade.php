    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a
            href="/property/{{ Session::get('property_id') }}/rooms/">{{ Session::get('property_name')}}</a></li>
  ...
  <div class="col-lg-12 mb-4">
    ...
    <div class="table-responsive" style="overflow-y:scroll;overflow-x:scroll;height:450px;">
      <form id="editUnitsForm"
        action="/property/{{Session::get('property_id') }}/units/{{ Carbon\Carbon::now()->getTimestamp()}}/update"
        method="POST">
      ...
      <table class="table table-hover table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <input col-md-12" form="editUnitsForm" type="text" name="unit_no{{ $unit_no++  }}" id=""
                value="{{ $item->unit_no }}">
    ...
    @if($units->count() <=0 ) @else <p class="text-right">
      <button type="submit" form="editUnitsForm" class="btn btn-primary btn-sm"
