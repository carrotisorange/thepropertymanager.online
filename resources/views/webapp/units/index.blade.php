...
<div class="row align-items-center py-4">
  ...
  <div class="col-md-6 text-right">
    ...
    @endif
    <a href="/property/{{Session::get('property_id')}}/units/{{ Carbon\Carbon::now()->getTimestamp() }}/edit"
      class="btn btn-primary btn-sm"><i class="fas fa-edit fa-sm text-dark-50"></i> Edit</a>
      ...
      <div class="row  text-center" style="overflow-y:scroll;overflow-x:scroll;height:450px;">
        ...
        <div class="col-md-2.5">
          ...
          <a title="₱ {{ number_format ($item->rent, 2)}}/mo"
            href="/property/{{Session::get('property_id')}}/unit/{{ $item->unit_id }}" class="btn btn-sm btn-success"
          ...
          <a title="₱ {{ number_format ($item->rent, 2)}}/mo"
            href="/property/{{Session::get('property_id')}}/unit/{{ $item->unit_id }}" class="btn btn-sm btn-danger"
            style="width: 85px; height: 60px;">
            <i class="fas fa-home fa-2x"></i>
            <br>
            <small> {{ $item->unit_no }}</small>
          ...
          <a title="₱ {{ number_format ($item->rent, 2)}}/mo"
            href="/property/{{Session::get('property_id')}}/unit/{{ $item->unit_id }}" class="btn btn-sm btn-dark"
            style="width: 85px; height: 60px;">
            <i class="fas fa-home fa-2x"></i>
            <br>
            <small> {{ $item->unit_no }}</small>
          ...
          <a title="₱ {{ number_format ($item->rent, 2)}}/mo"
            href="/property/{{Session::get('property_id')}}/unit/{{ $item->unit_id }}" class="btn btn-sm btn-warning"
            style="width: 85px  ; height: 60px;">
            <i class="fas fa-home fa-2x"></i>
            <br>
            <small> {{ $item->unit_no }}</small>
    ...
    <div class="tab-pane fade" id="nav-{{ $item->building }}" role="tabpanel"
      ...
      <div class="row  text-center" style="overflow-y:scroll;overflow-x:scroll;height:450px;">
        ...
        <div class="col-md-2.5">
          ...
          <a title="₱ {{ number_format ($item->rent, 2)}}/mo"
            href="/property/{{Session::get('property_id')}}/unit/{{ $unit->unit_id }}" class="btn btn-sm btn-success"
            style="width: 85px; height: 60px;">
          ...
          <a title="₱ {{ number_format ($item->rent, 2)}}/mo"
            href="/property/{{Session::get('property_id')}}/unit/{{ $unit->unit_id }}" class="btn btn-sm btn-danger"
            style="width: 85px; height: 60px;">
            @if($unit->unit_type_id_foreign == '1')
            <i class="fas fa-home fa-2x"></i>
            @elseif($unit->unit_type_id_foreign == '2')
          ...
          <a title="₱ {{ number_format ($item->rent, 2)}}/mo"
            href="/property/{{Session::get('property_id')}}/unit/{{ $unit->unit_id }}" class="btn btn-sm btn-dark"
            style="width: 85px; height: 60px;">
            @if($unit->unit_type_id_foreign == '1')
            <i class="fas fa-home fa-2x"></i>
            @elseif($unit->unit_type_id_foreign == '2')
          ...
          <a title="₱ {{ number_format ($item->rent, 2)}}/mo"
            href="/property/{{Session::get('property_id')}}/unit/{{ $unit->unit_id }}" class="btn btn-sm btn-warning"
            style="width: 85px  ; height: 60px;">
            @if($unit->unit_type_id_foreign == '1')
            <i class="fas fa-home fa-2x"></i>
            @elseif($unit->unit_type_id_foreign == '2')
...
<div class="modal fade" id="addMultipleUnits" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group residential" style="display:none">
          ...
          <input form="addUMultipleUnitForm" type="number" value="1" min="1" class="form-control" name="no_of_rooms"
            required>
        </div>
        ...
        <div class="form-group residential" style="display:none">
          ...
          <input form="addUMultipleUnitForm" type="number" step="0.001" class="form-control" name="size"
        ...
        <div class="form-group residential" style="display:none">
          ...
          <label>Floor</label>
          <select class="form-control" form="addUMultipleUnitForm" name="floor" id="floor"
        ...
        <div class="form-group residential" style="display:none">
          ...
          <input form="addUMultipleUnitForm" type="number" value="0" step="0.01" min="0" class="form-control"
            name="rent" id="rent">
        </div>
      ...
      <div class="modal-footer">
        ...
        <button style="display:none" id="submitButton" form="addUMultipleUnitForm" type="submit"
