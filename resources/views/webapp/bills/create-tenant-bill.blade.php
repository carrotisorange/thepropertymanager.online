        ...
        <div class="form-row">
          <table class="table table-borderless table-responsive">
            ...
            <tr>
              ...
              <td>
                <input class="form-control" form="createBillForm" type="date" value="{{ old('end') }}" name="end"
                  id="end" class="">
                @error('end')
                <small class="text-danger">
                  {{ $message }}
      ...
      <div class="form-group col-md-11 mx-auto">
        ...
        <p class="text-center">
          <a class="text-center text-dark"
            href="/property/{{ Session::get('property_id') }}/tenant/{{ $tenant->tenant_id }}/#bills">Cancel</a>
        </p>
      </div>
    </div>
  </div>
