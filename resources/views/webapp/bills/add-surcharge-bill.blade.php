...
<div class="row align-items-center py-4">
  <div class="col-md-9 text-left">
    <h6 class="h2 text-dark d-inline-block mb-0">Surcharges</h6>
  </div>
  ...
  <table class="table table-condensed table-bordered table-hover">
   ...
   ?>
    ...
    <tr>
      ...
      <input class="" type="hidden" form="add_billings" name="particular{{ $desc_ctr++ }}" value="Surcharge" required
        readonly>
      <td>

        <input form="add_billings" type="number" name="amount{{ $amt_ctr++ }}" step="0.01" value="0"
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="periodCoveredForm"
          action="/property/{{Session::get('property_id')}}/bills/surcharge/{{ $updated_start? Carbon\Carbon::parse($updated_start)->format('Y-m-d'): null }}-{{ Carbon\Carbon::parse($updated_end)->format('Y-m-d') }}/"
          method="POST">
          @csrf
          <div class="row">
            <div class="col">
