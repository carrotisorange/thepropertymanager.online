...
<div class="row">
  ...
  <br>
  <p class="text-right">
    <button type="submit" form="add_billings" id="addBillsButton" class="btn btn-primary btn-sm"  onclick="return confirm('Are you sure you want to perform this action?');"><i class="fas fa-check"></i> Post bills</button>
  </p>
