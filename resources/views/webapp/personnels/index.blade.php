...
<div class="row align-items-center py-4">
  ...
  <div class="col-lg-6 col-5 text-right">
    <a href="#" data-toggle="modal" data-target="#addPersonnelModal" class="btn btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Add Personnel</a>
  </div>


</div>
@if($employees->count() <=0 )
<p class="text-danger text-center">No employees and personnels found!</p>
...
@endif
   ...
   <div class="modal fade" id="addPersonnelModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-footer">
      ...
      <p class="text-right"> <button type="submit" form="addPersonnelForm" class="btn btn-primary"> Add Personnel</button></p>
   </div>
    </div>
</div>
</div>
