    ...
    <nav>
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <a class="nav-item nav-link active" id="nav-profile-tab" data-toggle="tab" href="#profile" role="tab"
          aria-controls="nav-profile" aria-selected="true"><i class="fas fa-user text-primary"></i> Profile</a>
        <a class="nav-item nav-link" id="nav-referrals-tab" data-toggle="tab" href="#referrals" role="tab"
          aria-controls="nav-referrals" aria-selected="false"><i class="fas fa-swimmer text-success"></i> Referrals</a>
        <a class="nav-item nav-link" id="nav-concerns-tab" data-toggle="tab" href="#concerns" role="tab"
          aria-controls="nav-concerns" aria-selected="false"><i class="fas fa-tools text-cyan"></i> Concerns</a>
        <a class="nav-item nav-link" id="nav-session-tab" data-toggle="tab" href="#session" role="tab"
          aria-controls="nav-session" aria-selected="false"><i class="fas fa-sign-in-alt text-teal"></i> Sessions</a>
        <a class="nav-item nav-link" id="nav-session-tab" data-toggle="tab" href="#settings" role="tab"
          aria-controls="nav-settings" aria-selected="false"><i class="fas fa-user-cog text-danger"></i> Settings</a>
      </div>
    </nav>
  </div>
</div>
    ...
    <div class="tab-content" id="nav-tabContent">
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="alert alert-danger alert-dismissable custom-danger-box">
              ...
              <strong><i class="fas fa-exclamation-triangle"></i> Don't forget to logout your account to record your
                usage time. </strong>
      ...
      <div class="tab-pane fade" id="settings" role="tabpanel" aria-labelledby="nav-settings-tab">
        ...
        <div class="col-md-11 mx-auto">
          ...
          <br>
          <label>Mobile</label>
          <input form="editUserForm" id="mobile" type="number"
            class="form-control form-control-user @error('mobile') is-invalid @enderror" name="mobile"
            value="{{ $user->mobile }}" required autocomplete="mobile">
          @error('mobile')
          <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
          </span>
