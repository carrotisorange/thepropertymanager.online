    ...
    <div class="col-md-6 mx-auto">
        <div class="card">
            <div class="card-body">
              ...
              <div class="form-group">
                <button type="submit" form="addCreditMemoForm" class="btn btn-primary btn-block" onclick="this.form.submit(); this.disabled = true;"> Save</button>
                <br>
                <p class="text-center">
                    <a class="text-center text-dark" href="/property/{{ Session::get('property_id') }}/tenant/{{ $tenant->tenant_id }}/#payments">Cancel</a>
                </p>
            </div>
