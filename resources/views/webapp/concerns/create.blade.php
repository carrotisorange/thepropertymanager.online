  ...
  <div class="container">
    ...
    <div class="row ">
      ...
      <div class="col-md-12 py-3">
        <form id="concernTenantForm"
          action="/property/{{Session::get('property_id')}}/tenant/{{ $tenant->tenant_id }}/concern/store"
          method="POST">
          @csrf
        </form>
        ...
        <div class="form-row">
          <div class="form-group col-md-4">
            <input form="concernTenantForm" name="reported_at" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}"
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            <input form="concernTenantForm" name="contact_no" placeholder="Contact No" value="{{ $tenant->contact_no }}"
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            <textarea form="concernTenantForm" name="details" placeholder="Details of the concern" cols="40" rows="5"
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            <input form="concernTenantForm" name="scheduled_at" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}"
              class="form-control" type="date" required>
          </div>
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            <textarea form="concernTenantForm" name="action_taken" placeholder="Course of action taken..." cols="40"
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            <textarea form="concernTenantForm" name="remarks" placeholder="Remarks..." cols="40" rows="5"
              class="form-control" required></textarea>
          </div>
        </div>
        ...
        <div class="form-row">
          <a href="/property/{{ Session::get('property_id') }}/tenant/{{ $tenant->tenant_id }}#concerns"
            class="btn btn-secondary btn-sm"><i class="fas fa-times"></i> Cancel</a>
          <button form="concernTenantForm" type="submit" class="btn btn-primary btn-sm"><i class="fas fa-check"></i>
            Submit</button>
        </div>
