    ...
    <div class="card">
        ...
        <div class="form-row">
          <table class="table table-responsive">
            ...
            <tr>
              ...
              <td>
                <input form="createBillForm" type="number" value="{{ old('quantity') }}" name="quantity" id="quantity"
                  class="form-control" oninput="autoCompute()">
                @error('quantity')
                <small class="text-danger">
                  {{ $message }}
      ...
      <div class="form-group col-md-11 mx-auto">
        <a class="btn btn-primary btn-block"
          href="/property/{{ Session::get('property_id') }}/room/{{ $room->unit_id }}/#concerns"> Finish</a>
      </div>
    </div>
  </div>
</div>
