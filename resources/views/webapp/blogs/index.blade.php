...
<div class="row">
  ...
  <div class="col-md-11 mx-auto">
    <form action="/property/{{Session::get('property_id')}}/blog" method="POST">
      ...
      <p class="text-right">
        <button type="submit" class="btn btn-primary" onclick="this.form.submit(); this.disabled = true;"><i
            class="fas fa-share fa-sm text-white-50"></i> share </button>
      </p>
    </form>
  </div>
  <br>
  ...
  <div class="col-md-11 mx-auto">
    ...
    <div class="jumbotron bg-transparent">
      ...
      <footer class="blockquote-footer">{{ $item->name }} <cite title="Source Title">on
          {{ Carbon\Carbon::parse($item->created_at)->format('M d Y') }}</cite></footer>
